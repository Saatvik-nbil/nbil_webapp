    ...
    <div className={`w-full py-32 relative ${className || ""}`}>
      <div className="relative w-full min-h-[500px] flex flex-col items-center justify-center">
        ...
        <div className="relative w-[400px] h-[500px] flex justify-center pointer-events-none z-0">
          ...
          >
            <div className="absolute top-0 left-0 w-32 h-10 bg-linear-to-t from-[#1e40af] to-[#3b82f6] rounded-t-xl border-t border-l border-r border-white/15" />
            <div className="absolute top-8 left-0 right-0 bottom-0 bg-linear-to-b from-[#1e40af] to-[#0a1f4d] rounded-b-xl rounded-tr-xl border border-white/15 shadow-[inset_0_0_40px_rgba(4,12,45,0.85)]" />
            <div className="absolute top-10 left-2 right-2 bottom-2 bg-[#081235] rounded-lg shadow-inner pointer-events-none" />
          </motion.div>
          ...
          <div className="absolute bottom-10 z-10 flex justify-center">
            {photos.map((photo, i) => {
              ...
              return (
                ...
                >
                  <img src={photo.image} alt="Gallery item" className="w-full h-full object-contain p-3 pointer-events-none" />
                </motion.div>
              );
            })}
          </div>
          ...
          <motion.div
            className="absolute bottom-0 w-[340px] h-44 drop-shadow-[0_-20px_40px_rgba(23,64,175,0.55)] cursor-pointer z-20 pointer-events-auto"
          ...
          >
            <div className="w-full h-full bg-linear-to-b from-[#3b82f6] to-[#1e3a8a] rounded-2xl border border-white/25 shadow-[inset_0_2px_10px_rgba(255,255,255,0.18)] relative overflow-hidden flex items-end justify-center pb-8">
              <div className="absolute top-0 left-0 right-0 h-px bg-linear-to-r from-transparent via-white/50 to-transparent" />

              <div className="px-5 py-2.5 bg-[#081235] rounded-lg border border-white/15 shadow-inner flex items-center justify-center backdrop-blur-md">
