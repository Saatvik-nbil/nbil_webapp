...
function SocialLink({
  ...
  return (
    <a
      ...
      className="flex size-9 items-center justify-center rounded text-muted-foreground hover:text-foreground hover:bg-foreground/10 transition-all duration-150 hover:scale-110"
      title={title}
    >
      {children}
    </a>
