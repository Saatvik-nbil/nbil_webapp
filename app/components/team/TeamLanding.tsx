...
const TEAM: TeamMember[] = [
  ...
  { id: "t10", name: "Pooja Sawant", role: "Field Application Scientist", image: "/team/poojaawant.webp", social: { linkedin: "https://www.linkedin.com/in/pooja-sawant-31b6a120b/" } },
  { id: "t4", name: "Aseem Gupta", role: "Engineer · Software & AI", image: "/team/Aseem Gupta.webp", social: { linkedin: "https://www.linkedin.com/in/theaseemgupta/" } },
  { id: "t5", name: "Saatvik S Shastry", role: "Engineer · Software & AI", image: "/team/Saatvik.webp", social: { linkedin: "https://www.linkedin.com/in/saatvik-shastry-a9a38a212/" } },
            ...
            return (
              ...
              >
                <a
                  ...
                  className="relative block aspect-[4/5] overflow-hidden rounded-2xl border border-[var(--color-hairline)] bg-[var(--color-surface-raised)]"
                >
                  <Image
                    src={f.image}
                    alt={f.name}
