  ...
  return (
    ...
    >
      ...
      <h1
        ...
        className="relative mt-6 font-display text-[2.1rem] font-semibold leading-[1]! tracking-[-0.032em] text-[var(--color-ink)] sm:text-[2.6rem] lg:text-[2.7rem] xl:text-[3.4rem]"
      >
