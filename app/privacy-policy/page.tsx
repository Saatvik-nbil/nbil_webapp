      ...
      <main className="bg-[var(--color-bg)]">
        <article className="max-w-3xl mx-auto px-6 pt-32 pb-24">
          ...
          <header className="mb-12 border-b border-[var(--color-hairline)] pb-10">
            <p className="text-[12px] font-mono uppercase tracking-[0.14em] text-[var(--color-ink-faint)] mb-4">
              Legal
            </p>
          ...
          <div className="flex flex-col gap-10 text-[15px] leading-[1.75] text-[var(--color-ink-muted)]">
            <p>
              Next Big Innovation Labs&reg; (&ldquo;we,&rdquo; &ldquo;our,&rdquo;
              ...
              used, and disclosed by Next Big Innovation Labs&reg;.
            </p>
            <p>
              ...
              application, Next Big Innovation Labs. By accessing or using our
            ...
            <Section title="Definitions and key terms">
              ...
              <ul className={listClass}>
                <li>
                  <Term>Cookie:</Term> small amount of data generated by a website
                ...
                <li>
                  <Term>Country:</Term> where Next Big Innovation Labs or the
                  owners/founders of Next Big Innovation Labs are based, in this
                  case is India.
                </li>
                <li>
                  <Term>Customer:</Term> refers to the company, organization or
                  person that signs up to use the Next Big Innovation Labs Service
                  to manage the relationships with your consumers or service users.
                </li>
                <li>
                  <Term>Device:</Term> any internet connected device such as a
                  phone, tablet, computer or any other device that can be used to
                  visit Next Big Innovation Labs and use the services.
                </li>
                <li>
                  <Term>IP address:</Term> Every device connected to the Internet
                ...
                <li>
                  <Term>Personnel:</Term> refers to those individuals who are
                  employed by Next Big Innovation Labs or are under contract to
                ...
                <li>
                  <Term>Service:</Term> refers to the service provided by Next Big
                  Innovation Labs as described in the relative terms (if available)
                  and on this platform.
                </li>
                <li>
                  <Term>Third-party service:</Term> refers to advertisers, contest
                  sponsors, promotional and marketing partners, and others who
                  provide our content or whose products or services we think may
                  interest you.
                </li>
                <li>
                  <Term>Website:</Term> Next Big Innovation Labs.&rsquo;s site,
                  which can be accessed via this URL: http://www.nextbiglab.com
                </li>
                <li>
                  <Term>You:</Term> a person or entity that is registered with Next
                  Big Innovation Labs to use the Services.
                </li>
              </ul>
            </Section>
            ...
            <Section title="When does Next Big Innovation Labs use end user information from third parties?">
              <p>
                Next Big Innovation Labs will collect End User Data necessary to
                provide the Next Big Innovation Labs services to our customers.
              </p>
              <p>
            ...
            <Section title="When does Next Big Innovation Labs use customer information from third parties?">
              <p>
                ...
                interest in becoming a Next Big Innovation Labs customer, we receive
                information from a third party that provides automated fraud
                detection services to Next Big Innovation Labs. We also occasionally
            ...
            <Section title="Do we share the information we collect with third parties?">
              <p>
                ...
                asset sale or other business re-organization, we may also share or
            ...
            <Section title="Where and when is information collected from customers and end users?">
              <p>
                Next Big Innovation Labs will collect personal information that you
            ...
            <Section title="How Long Do We Keep Your Information?">
              <p>
                We keep your information only so long as we need it to provide Next
                Big Innovation Labs to you and fulfill the purposes described in
                ...
                keep it to comply with our legal or regulatory obligations, we&rsquo;ll
            ...
            <Section title="How Do We Protect Your Information?">
              <p>
                ...
                information you transmit to Next Big Innovation Labs or guarantee
            ...
            <Section title="Could my information be transferred to other countries?">
              <p>
                Next Big Innovation Labs is incorporated in India. Information
            ...
            <Section title="Is the information collected through the Next Big Innovation Labs Service secure?">
              <p>
            ...
            <Section title="Can I update or correct my information?">
              <p>
                ...
                information Next Big Innovation Labs collects depend on your
                relationship with Next Big Innovation Labs. Personnel may update or
            ...
            <Section title="Personnel">
              <p>
                If you are a Next Big Innovation Labs worker or applicant, we
            ...
            <Section title="Sale of Business">
              <p>
                ...
                all of the assets of Next Big Innovation Labs or any of its Corporate
                Affiliates (as defined herein), or that portion of Next Big
                Innovation Labs or any of its Corporate Affiliates to which the
            ...
            <Section title="Affiliates">
              <p>
                ...
                Policy, &ldquo;Corporate Affiliate&rdquo; means any person or entity
                which directly or indirectly controls, is controlled by or is under
                common control with Next Big Innovation Labs, whether by ownership or
            ...
            <Section title="Governing Law">
              ...
              <p>
                By using Next Big Innovation Labs or contacting us directly, you
                signify your acceptance of this Privacy Policy. If you do not agree
                to this Privacy Policy, you should not engage with our website, or
                use our services. Continued use of the website, direct engagement
            ...
            <Section title="Your Consent">
              <p>
                ...
                it&rsquo;s being used. By using our website, registering an account,
            ...
            <Section title="Links to Other Websites">
              <p>
                ...
                contain links to other websites not operated or controlled by Next
                Big Innovation Labs. We are not responsible for the content, accuracy
            ...
            <Section title="Blocking and disabling cookies and similar technologies">
              <p>
                Wherever you&rsquo;re located you may also set your browser to block
            ...
            <Section title="Remarketing Services">
              <p>
                ...
                website. It allows your company to seem like they&rsquo;re
            ...
            <Section title="Third-Party Services">
              ...
              <p>
                You acknowledge and agree that Next Big Innovation Labs shall not be
                ...
                decency, quality or any other aspect thereof. Next Big Innovation
                Labs does not assume and shall not have any liability or
              ...
              <p>
                ...
                risk and subject to such third parties&rsquo; terms and conditions.
              </p>
            </Section>

            <Section title="Information about General Data Protection Regulation (GDPR)">
              <p>
            ...
            <Section title="What is GDPR?">
              <p>
                GDPR is an EU-wide privacy and data protection law that regulates how
                EU residents&rsquo; data is protected by companies and enhances the
            ...
            <Section title="What is personal data?">
              <p>
                ...
                a person. Personal data extends beyond a person&rsquo;s name or email
            ...
            <Section title="Why is GDPR important?">
              <p>
                ...
                enforcement and imposing greater fines for breach. Beyond these facts
                it&rsquo;s simply the right thing to do. At Next Big Innovation Labs
            ...
            <Section title="Individual Data Subject's Rights — Data Access, Portability and Deletion">
              <p>
                ...
                stores all personal data in fully vetted, DPA compliant vendors. We
              ...
              <p>
                ...
                remove personal data. We got you! We&rsquo;ve been set up as self
            ...
            <Section title="California Residents">
              ...
              <ul className={listClass}>
                <li>
                  <Term>Right to Know and Access.</Term> You may submit a verifiable
                ...
                <li>
                  <Term>Right to Equal Service.</Term> We will not discriminate
                  against you if you exercise your privacy rights.
                </li>
                <li>
                  <Term>Right to Delete.</Term> You may submit a verifiable request
                  to close your account and we will delete Personal Information about
                  you that we have collected.
                </li>
                <li>
                  Request that a business that sells a consumer&rsquo;s personal data,
            ...
            <Section title="Contact Us">
              <p>
                Don&rsquo;t hesitate to contact us if you have any questions.
              </p>
              <ul className={listClass}>
                <li>
                  Via Email:{" "}
