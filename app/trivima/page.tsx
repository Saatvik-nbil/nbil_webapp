...
const itemListSchema = {
  ...
  description:
    "The full range of Trivima bioprinters by Next Big Innovation Labs, from compact benchtop extrusion bioprinters to non-planar rotary and light-based bioprinting systems.",
